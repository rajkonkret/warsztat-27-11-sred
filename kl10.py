...
class Person:
    ...
    def greet(self):
        print(f"witam jestem {self.first_name} {self.last_name} Id {self.id}")


print(__name__)
if __name__ == '__main__':  # jesli wykonujemy plik bezposrednnio kod sie wykona, gdy importujemy nie bedzie wykonany
